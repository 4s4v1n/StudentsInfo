...
import { PassOneTwoService } from "../../../services/fnc_pass_one_two.service/PassOneTwoService";

const PassOneTwo = () => {

    const decribe = "Determine all peers who did the given tasks 1 and 2, but did not do task 3"
    ...
    const { mutate, isLoading, error } = useMutation(
        (values) => PassOneTwoService.Get(values),
        {
            onSuccess: (result) => {
                setData(result);
    ...
    const queries = ["task_1", "task_2", "task_3"];
